    ...
    <div className="p-4 space-y-6 bg-background flex-grow">
      <Card className="shadow-lg border-primary border-2">
        <CardHeader>
          ...
          <CardDescription>Votre assistant financier par comptes. Date: {format(currentDate, 'PPP', { locale: fr })}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-3xl font-bold text-foreground">
            Solde Compte Courant: {compteCourantBalance.toLocaleString('fr-FR')} {CURRENCY_SYMBOL}
          </div>
