...
self.addEventListener('fetch', (event) => {
  ...
  // Don't cache API routes or Supabase auth requests
  if (event.request.url.includes('/api/') || event.request.url.includes('supabase.co') || event.request.url.includes('/_next/static/development/')) {
